            ...
            <div className="grid md:grid-cols-2">
              <div className="h-full pr-6">
                ...
                <ul className="mb-6 md:mb-0">
                  <li className="flex">
                    <div className="flex items-center justify-center w-10 h-10 bg-pink-600 rounded text-gray-50">
                      <svg
              ...
              <div className="max-w-6xl p-5 card h-fit md:p-12" id="form">
                ...
                <form id="contactForm">
                  ...
                  <div className="text-center">
                    <button
                      type="submit"
                      className="w-full px-6 py-3 text-white bg-pink-500 rounded-md font-xl sm:mb-0"
                    >
                      Send Message
                    </button>
                  </div>
