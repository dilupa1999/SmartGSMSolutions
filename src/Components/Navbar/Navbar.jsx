...
export default function NavbarTopBar() {
  ...
  return (
    <>
        ...
        <div className="mx-auto grid w-full max-w-full grid-cols-4 gap-6 px-6 py-2 text-sm text-white md:grid-cols-8 lg:max-w-5xl lg:grid-cols-12 xl:max-w-7xl 2xl:max-w-[96rem]">
          <div className="items-center col-span-2 md:col-span-4 lg:col-span-6">
            <a
              ...
              className="flex items-center gap-2 transition-colors duration-300 hover:text-rose-500"
            >
              <svg
          ...
          <div className="items-center justify-end col-span-2 gap-6 md:col-span-4 lg:col-span-6">
      ...
      {/*<!-- Header --> */}
      <header className="relative z-20 w-full bg-black shadow-lg border-slate-200 shadow-slate-700/5 after:absolute after:left-0 after:top-full after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
          ...
          >
            ...
            <div className="flex items-center justify-end px-6 ml-auto lg:ml-0 lg:flex-1 lg:p-0">
              <a
                href="#"
                className="relative inline-flex items-center justify-center w-10 h-10 text-lg rounded-full text-rose-500"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-5 h-5"
